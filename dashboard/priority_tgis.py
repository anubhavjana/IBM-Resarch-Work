...
def get_stats(user):
    ...
    plot_histogram_with_cdf(queue_data, 'Queue Time (s)', 'Cumulative Probability', f'Queue Time CDF for User {user} (MAX OP TOKENS = 60)', f'images/{user}_tgis_llama_queue_time_cdf.png')
    plot_histogram_with_cdf(latency_data, 'Latency (s)', 'Cumulative Probability', f'Latency CDF for User {user} (MAX OP TOKENS = 60)', f'images/{user}_tgis_llama_latency_cdf.png')
