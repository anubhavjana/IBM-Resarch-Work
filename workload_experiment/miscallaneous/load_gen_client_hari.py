...
class OpenShiftClient:
	...
	def create_pod(self, w_type,user_id):
		...
		try:
			...
			print(f"Create workload pod for user: ", user_id)
		except Exception as e:
			print("Error :", e.body)
	...
	def log_data(self, start_time, end_time, user):
		"""
		...
		file_name = "bloom_router_mig3g_a100_alan.jsonl"
...
def main():
	...
	openshift_client.delete_pod("tgis-grpc-load-bloom-router-mig3g-hari")
	...
	# for rr in range(60,90,10): # request rate
	
	openshift_client.create_pod("bloom_hari",user)
	...
	openshift_client.log_data(start, end, user)

	openshift_client.delete_pod("tgis-grpc-load-bloom-router-mig3g-hari") #experiment over ---  delete pod
