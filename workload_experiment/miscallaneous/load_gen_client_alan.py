...
def main():
	...
	openshift_client.delete_pod("tgis-grpc-load-bloom-router-mig3g-alan")
	...
	openshift_client.create_pod("bloom_alan",user)
	...
	openshift_client.delete_pod("tgis-grpc-load-bloom-router-mig3g-alan") #experiment over ---  delete pod
