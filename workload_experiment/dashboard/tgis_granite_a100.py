...
def analyze_model(model_name):
    request_rates = {
        'granite': [30, 35, 40, 45, 48, 50, 52, 55, 60]
    }
    ...
    for rate in request_rates[model_name]:
        # folder = f'metrics_data/{model_name}/tgis/{rate}/'

        folder = f'no_priority_exps_op_60/granite_a100_no_priority/rr_{rate}_op_60/tgis/'
