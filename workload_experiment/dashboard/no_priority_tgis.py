...
tgis_llama_data_folder = 'router_experiments_data/no_priority_tgis_6.6.6_op_60/tgis/'
...
tgi_filter_llama = {'pod':['llama3-v3']}
...
def get_stats(user):
    ...
    plot_histogram_with_cdf(queue_data, 'Queue Time (s)', 'Cumulative Probability', f'No-Priority Queue Time CDF for User {user} (MAX OP TOKENS = 60)', f'images/{user}_no_priority_tgis_llama_queue_time_cdf.png')
    plot_histogram_with_cdf(latency_data, 'Latency (s)', 'Cumulative Probability', f'No-Priority Latency CDF for User {user} (MAX OP TOKENS = 60)', f'images/{user}_no_priority_tgis_llama_latency_cdf.png')
...
for user in users:
    print("Stats for LLama-A100 With NO PRIORITY...\n") 
    get_stats(user)
    print('-------------------------------------------------------------------------------------------------------------------------------------\n')
