...
tgis_llama_data_folder = 'router_experiments_data/priority_in_router_4.4.4/tgis/'

router_data_folder = 'router_experiments_data/priority_in_router_4.4.4/router/'
...
router_filter = {"pod" : ['llm-router-v9']} 
...
print("Stats for LLama-A100 With Priority in Router...\n") 
for user in users:
