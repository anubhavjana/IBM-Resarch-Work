...
tgis_llama_data_folder = f'router_experiments_data/llama3_a100_no_priority/rr_{rr}_op_{op}/tgis/'
...
def get_stats(rr,op,user):
    ...
    if(pd.isna(tgis_latency_df.mean())):
        ...
        # print(f'50 %ile latency is: {tgis_latency_df.quantile(0.50)}')
