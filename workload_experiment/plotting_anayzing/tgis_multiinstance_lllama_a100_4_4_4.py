...
def get_stats(user):
    ...
    plot_histogram_with_cdf(queue_data, 'Queue Time (ms)', 'Cumulative Probability', f'Queue Time CDF for User {user}', f'{user}_queue_time_tgis_4.4.4_llama_a100_time.png')
    plot_histogram_with_cdf(latency_data, 'Latency (ms)', 'Cumulative Probability', f'Latency CDF for User {user}', f'{user}_latency_4.4.4_llama_a100_time.png')
