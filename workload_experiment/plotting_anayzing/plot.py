...
# tgis_data_folder = 'metrics_data/a100/tgis/max_wait_tokens_20/60/'
# gpu_data_folder = 'metrics_data/a100/gpu/max_wait_tokens_20/60/'
...
router_data_folder = 'router_experiments_data/'+str(rr)+'/router_with_priority/router/'
tgis_data_folder = 'router_experiments_data/'+str(rr)+'/router_with_priority/tgis/'
gpu_data_folder = 'router_experiments_data/'+str(rr)+'/router_with_priority/gpu/'
...
# tgis_data_folder = 'metrics_data/a100/tgis/bloom/old_prompt/'+str(rr)+'/'
# gpu_data_folder = 'metrics_data/a100/gpu/bloom/old_prompt/'+str(rr)+'/'

# tgis_data_folder = 'metrics_data/mig3g_40gb/tgis/bloom/'+str(rr)+'/'
# gpu_data_folder = '/metrics_data/mig3g_40gb/gpu/bloom/'+str(rr)+'/'


# tgis_data_folder = 'metrics_data/a100/tgis/bloom/new_prompt/'+str(rr)+'/'
# gpu_data_folder = 'metrics_data/a100/gpu/bloom/new_prompt/'+str(rr)+'/'


# tgis_data_folder = 'metrics_data/a100/tgis/lower_rr_new_prompt/15/'
# gpu_data_folder = 'metrics_data/a100/gpu/lower_rr_new_prompt/15/'


# tgis_data_folder = 'metrics_data/a100/tgis/updated_dataset/30/'
# gpu_data_folder = 'metrics_data/a100/gpu/updated_dataset/30/'

# tgis_data_folder = 'metrics_data/mig3g_40gb/tgis/old_prompt/70/'
# gpu_data_folder = 'metrics_data/mig3g_40gb/gpu/old_prompt/70/'

# rr = 110
# tgis_data_folder = 'metrics_data/mig3g_40gb/tgis/new_prompt/'+str(rr)+'/'
# gpu_data_folder = 'metrics_data/mig3g_40gb/gpu/new_prompt/'+str(rr)+'/'



# tgis_data_folder = 'metrics_data/a100/tgis/110/'
# gpu_data_folder = 'metrics_data/a100/gpu/110/'
...
# gpu_filter = {'exported_pod':['llama3-mig3g-40gb']}
# tgi_filter = {'pod':['llama3-mig3g-40gb']}

# gpu_filter = {'exported_pod':['llama3']}
# tgi_filter = {'pod':['llama3']}

# gpu_filter = {'exported_pod':['bloom']}
# tgi_filter = {'pod':['bloom'], 'user':['Alan']}
...
# merged_dataframe = pd.merge_asof(tgi_df, gpu_df, on="timestamp")

# merged_dataframe['tgi_request_inference_duration_sum_g'] = merged_dataframe['tgi_request_inference_duration_sum'].diff()
# merged_dataframe['tgi_request_duration_sum_g'] = merged_dataframe['tgi_request_duration_sum'].diff()
# merged_dataframe['tgi_request_generated_tokens_sum_g'] = merged_dataframe['tgi_request_generated_tokens_sum'].diff()
# merged_dataframe['tgi_request_queue_duration_sum_g'] = merged_dataframe['tgi_request_queue_duration_sum'].diff()

# temp = merged_dataframe.iloc[:].sort_values('tgi_batch_current_size')
# temp.reset_index(inplace=True, drop=True)

########################################################################################################################

# figure(figsize=(18, 6), dpi=80)
# plt.plot(temp['tgi_batch_current_size'],'*')
# plt.plot(temp['tgi_request_inference_duration_sum_g'],'*')
# plt.plot(temp['tgi_request_duration_sum_g'],'*')
# plt.plot(temp['tgi_request_queue_duration_sum_g'],'*')

# plt.legend(['batch size', 'inference duration', 'request duration', 'queue duration'])
# plt.show()
########################################################################################################################
...
# figure(figsize=(18, 6), dpi=80)
# plt.plot(temp['tgi_batch_current_size'], temp['tgi_request_queue_duration_sum_g'],'*')
# plt.show()
...
# figure(figsize=(18, 6), dpi=80)
# plt.plot(temp['tgi_request_queue_duration_count'],'*')
# plt.show()
...
# figure(figsize=(18, 6), dpi=80)
# plt.plot(temp['tgi_request_generated_tokens_sum_g'],'*')
# plt.show()

#########################################################################################################################

# figure(figsize=(18, 6), dpi=80)
# plt.plot(temp['DCGM_FI_PROF_PIPE_TENSOR_ACTIVE'], '*')
# plt.plot(temp['DCGM_FI_PROF_SM_ACTIVE'], '*')
# plt.plot(temp['DCGM_FI_PROF_SM_OCCUPANCY'], '*')

# plt.legend(['Tensor', 'SM Active', 'SM Occupancy'])
# plt.show()

#########################################################################################################################

# figure(figsize=(18, 6), dpi=80)
# plt.plot(gpu_df['DCGM_FI_DEV_POWER_USAGE'], '*')
# plt.show()

# figure(figsize=(18, 6), dpi=80)
# plt.plot(gpu_df['DCGM_FI_DEV_TOTAL_ENERGY_CONSUMPTION'], '*')
# plt.show()
...
tgi_data = tgi_df[['timestamp', 'tgi_request_queue_duration_sum', 'tgi_request_queue_duration_count','tgi_batch_current_size', 'tgi_queue_size', 'tgi_request_failure', 'tgi_request_generated_tokens_sum', 'tgi_request_generated_tokens_count', 'tgi_request_mean_time_per_token_duration_sum', 'tgi_request_duration_sum', 'tgi_request_duration_count', 'tgi_request_inference_duration_sum', 'tgi_request_inference_duration_count','tgi_request_total_tokens_sum','tgi_request_input_length_sum','tgi_request_input_length_count']]

# print(tgi_data)
# tgi_data = merged_dataframe[['timestamp', 'tgi_batch_current_size', 'tgi_queue_size', 'tgi_request_queue_duration_sum', 'tgi_request_generated_tokens_sum', 'tgi_request_generated_tokens_count', 'tgi_request_mean_time_per_token_duration_sum', 'tgi_request_duration_sum', 'tgi_request_duration_count', 'tgi_request_queue_duration_count', 'tgi_request_inference_duration_sum', 'tgi_request_inference_duration_count','tgi_request_total_tokens_sum']]

columns = ['tgi_request_inference_duration_count','tgi_request_failure', 'tgi_request_inference_duration_sum', 'tgi_request_duration_count','tgi_request_generated_tokens_sum', 'tgi_request_mean_time_per_token_duration_sum','tgi_request_duration_sum','tgi_request_input_length_sum','tgi_request_input_length_count','tgi_request_generated_tokens_count',]
...
# Calculate the average of the "tgi_queue_size" column
tgi_queue_size_values = tgi_data['tgi_queue_size']
percentile_95_queue_size = tgi_queue_size_values.quantile(0.95)
print("--------------95 percentile Mean Queue Size--------------",percentile_95_queue_size)
print("----------------------Max Queue size-------",tgi_queue_size_values.max())
...
# mean_token_time_values = tgi_data['tgi_request_mean_time_per_token_duration_sum']/temp['tgi_request_inference_duration_count']

# average_latency_per_token = mean_token_time_values.mean()

# print("----------------------Mean Token Time:----------------------", average_latency_per_token)
...
# print("Average number of request failures------------",tgi_data['tgi_request_failure'].mean())
...
# temp['mean_token_latency'] = temp['latency'] / temp['tokens'] # with queue 
...
print("--------------95 percentile Mean Queue Waiting Time--------------",percentile_95_queue_waiting_time)
print("--------------Mean Queue Waiting Time--------------",mean_queue_time)
print("--------------Max Queue Waiting Time--------------",temp['mean_queue_time'] .max())
